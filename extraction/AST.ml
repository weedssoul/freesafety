...
let print_external_function fmt ef =
  match ef with
  | EF_external (id, s) -> fprintf fmt "EF_external: %s" (extern_atom id)
  | EF_builtin (id, s) -> fprintf fmt "EF_builtin: %s" (extern_atom id)
  | EF_vload _ -> fprintf fmt "EF_vload"
  | EF_vstore _ -> fprintf fmt "EF_vstroe"
  | EF_vload_global _ -> fprintf fmt "EF_vload_global"
  | EF_vstore_global _ -> fprintf fmt "EF_vstore_global"
  | EF_malloc -> fprintf fmt "EF_malloc"
  | EF_free -> fprintf fmt "EF_free"
  | EF_memcpy _ -> fprintf fmt "EF_memcpy"
  | EF_annot _ -> fprintf fmt "EF_annot"
  | EF_annot_val _ -> fprintf fmt "EF_annot_val"
  | EF_inline_asm _ -> fprintf fmt "EF_inline_asm"
