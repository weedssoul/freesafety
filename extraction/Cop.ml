...
let classify_bool ty =
  ...
  | Tfloat (f, a) ->
    (match f with
     | F32 -> Coq_bool_case_s
     | F64 -> Coq_bool_case_f)
  | Tpointer (t, o, a) -> Coq_bool_case_p
  | Tcomp_ptr (i, a, _, _) -> Coq_bool_case_p
  | _ -> Coq_bool_default
...
let classify_add ty1 ty2 =
  ...
  | Tint (i, s, a) ->
    (match typeconv ty2 with
     | Tpointer (ty, o, a0) -> Coq_add_case_ip ty
     | _ -> Coq_add_default)
  | Tlong (s, a) ->
    (match typeconv ty2 with
     | Tpointer (ty, o, a0) -> Coq_add_case_lp ty
     | _ -> Coq_add_default)
  | Tpointer (ty, o, a) ->
    (match typeconv ty2 with
...
let classify_sub ty1 ty2 =
  ...
  | Tpointer (ty, o, a) ->
    (match typeconv ty2 with
     ...
     | Tpointer (t, o, a0) -> Coq_sub_case_pp ty
     | _ -> Coq_sub_default)
  | _ -> Coq_sub_default
...
let classify_cmp ty1 ty2 =
  ...
  | Tint (i, s, a) ->
    (match typeconv ty2 with
     | Tpointer (t, o, a0) -> Coq_cmp_case_pp
     | _ -> Coq_cmp_default)
  | Tlong (s, a) ->
    (match typeconv ty2 with
     | Tpointer (t, o, a0) -> Coq_cmp_case_lp
     | _ -> Coq_cmp_default)
  | Tpointer (t, o, a) ->
    (match typeconv ty2 with
     | Tint (i, s, a0) -> Coq_cmp_case_pp
     | Tlong (s, a0) -> Coq_cmp_case_pl
     | Tpointer (t0, o, a0) -> Coq_cmp_case_pp
     | _ -> Coq_cmp_default)
  | _ -> Coq_cmp_default
...
| Tpointer (t, o, a) ->
  (match t with
   | Tfunction (args, _, res, cc) -> Coq_fun_case_f (args, res, cc)
   | _ -> Coq_fun_default)
| Tfunction (args, _, res, cc) -> Coq_fun_case_f (args, res, cc)
| _ -> Coq_fun_default
...
let incrdecr_type ty =
  ...
  | Tpointer (ty0, o, a) -> Tpointer (ty0, o, a)
  | _ -> Tvoid
