...
let coq_Eindex r1 r2 ty =
  Ederef ((Ebinop (Oadd, r1, r2, (Tpointer (ty, Ownership.empty (), noattr)))), ty)
...
let type_of_function f =
  (* TODO: ok? *)
  Tfunction ((type_of_params f.fn_params), (type_of_params f.fn_params),
...
| External (id, args, res, cc) -> Tfunction (args, args, res, cc)
