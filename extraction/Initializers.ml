          ...
          (match ty with
           | Tint (i, sg, a0) ->
             (match i with
              ...
              | I32 -> OK (Init_int32 n)
              | _ -> OK (Init_int8 n))
           | Tpointer (t, o, a0) -> OK (Init_int32 n)
           | Tcomp_ptr (i, a0, _, _) -> OK (Init_int32 n)
           | _ ->
             Error
               (msg
             ...
             (match i with
              ...
              | _ ->
                Error
                  (msg
                    ('t'::('y'::('p'::('e'::(' '::('m'::('i'::('s'::('m'::('a'::('t'::('c'::('h'::(' '::('i'::('n'::(' '::('i'::('n'::('i'::('t'::('i'::('a'::('l'::('i'::('z'::('e'::('r'::[]))))))))))))))))))))))))))))))
           | Tpointer (t, o, a0) -> OK (Init_addrof (id, ofs))
           | Tcomp_ptr (i, a0, _, _) -> OK (Init_addrof (id, ofs))
           | _ ->
             Error
               (msg
                 ('t'::('y'::('p'::('e'::(' '::('m'::('i'::('s'::('m'::('a'::('t'::('c'::('h'::(' '::('i'::('n'::(' '::('i'::('n'::('i'::('t'::('i'::('a'::('l'::('i'::('z'::('e'::('r'::[])))))))))))))))))))))))))))))))
...
| Init_array il ->
  (match ty with
   | Tarray (tyelt, nelt, o, a) -> transl_init_array tyelt il (Z.max Z0 nelt)
   | _ ->
     Error
       (msg
